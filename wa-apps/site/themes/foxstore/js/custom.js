...
$(function(){
     $("footer#js-footer-wrapper").append("<div  style='text-align: center; color: #ddd;font-size: 13px;'><a href='https://www.brandfox.ru '>При участии web студии </a>Brandfox.ru и <a href='https://www.rekcom.ru '> конструктора сайтов</a> rekcom.ru</div></br>");
});    
